...
arg_parser.add_argument("design_toml", type=argparse.FileType('r'), help="Design description file")
...
sigasi_lib_map["mappings"][0]["files"].extend(xeda_design.get("tb", {}).get("sources",[]))
